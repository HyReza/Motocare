    ...
    <div class="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
        <div class="sm:flex sm:items-center sm:justify-between">
            <div class="text-white">
                <img class="h-32" src="images/1.svg" alt="">
            </div>
        ...
        <div class="grid grid-cols-1 gap-8 border-t border-gray-100 pt-8 sm:grid-cols-2 lg:grid-cols-4 lg:pt-16">
            <div>
                ...
                <ul class="mt-6 space-y-4 text-sm">
                    <li>
                        <a href="#" class="text-white transition hover:opacity-75"> Service </a>
                    </li>

                    <li>
                        <a href="#" class="text-white transition hover:opacity-75"> Oil detector </a>
                    </li>

                    <li>
                        <a href="#" class="text-white transition hover:opacity-75"> Service Detector </a>
                    </li>
        ...
        <p class="text-xs text-gray-500">&copy; 2024. Reza Edi Saputra. All rights reserved.</p>
    </div>
</footer>
